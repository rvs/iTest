...
import org.apache.itest.JUnitUtils
...
public class JUnitUtilsTest {
  ...
  static void tearDown() {
    def testReports = ['TEST-org.apache.itest.DummyTestError.xml', 'TEST-org.apache.itest.DummyTestFail.xml',
                       'TEST-org.apache.itest.DummyTestPass.xml', '/tmp/TEST-org.apache.itest.DummyTestPass.xml'];
    testReports.each {
      (new File(it)).delete()
    }
  }
  ...
  void testCustomOutput() {
    System.setProperty('org.apache.itest.JUnitUtils.results.dir', '/tmp');
    JUnitUtils.executeTests(DummyTestPass.class);

    def f = new File('/tmp/TEST-org.apache.itest.DummyTestPass.xml')
